      ...
      <section className="p-2">
        <div className="rounded-5 shadow">
          <div className="d-flex justify-content-around align-items-center py-3">
            <span className="fs-4 fw-bolder"> Progress Overview</span>
            <select className={`rounded-3 ${Styles.dropdown} text-muted`}>
          ...
          <div>
            <div className={`${Styles.card}`}>
                ...
                <div className={`${Styles.resultslist}`}>
                  <div className={`${Styles.entry}`}>
                    ...
                    <div className={`${Styles.desc}`}>
                      ...
                      <span>
                        Use our ChatGPT plug-in to generate a new document
                      </span>
                    </div>
                  ...
                  <div className={`${Styles.entry}`}>
                    ...
                    <div className={`${Styles.desc}`}>
                      ...
                      <span>
                        Use our free templates to quickly create a document
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className={`${Styles.cardfooter}`}>
                ...
                <p className={`${Styles.label} ${Styles.editactions}`}>
                  Edit Actions
                </p>
              </div>
            </div>
          ...
          <div className="pb-4 pt-2">
            <div className="ps-3 pb-2 ">
              <i className="fa-solid fa-bell"></i> Notifiaction
            </div>
            <div className="notifiactioncard m-auto">
